...
######## OBJECTIF 2 #####################
OBJ2 <- read.csv(file = file.choose(),header = T,
                 sep = ";",dec = ",",stringsAsFactors = F)
...
zip2 <- zeroinfl(Average.No.of.Aphids~Ants.Presence+
                   Mat.Location+Season+Average.Temp+
                   Relative.Humidity+Average.Rainfall|Ants.Presence+
                   Mat.Location+Season+Average.Temp+
                   Relative.Humidity+Average.Rainfall,
...
### Negative binomial
library(MASS)
negbin2 <- glm.nb(Average.No.of.Aphids~Ants.Presence+
                    Mat.Location+Season+Average.Temp+
                    Relative.Humidity+Average.Rainfall,
                  data = OBJ2)
...
zig2 <- zeroinfl(Average.No.of.Aphids~Ants.Presence+
                   Mat.Location+Season+Average.Temp+
                   Relative.Humidity+Average.Rainfall|Ants.Presence+
                   Mat.Location+Season+Average.Temp+
                   Relative.Humidity+Average.Rainfall,
...
######## OBJECTIF 3 #####################
OBJ3 <- read.csv(file = file.choose(),header = T,
                 sep = ";",dec = ",",stringsAsFactors = F)
...
### Zero inflated geometric
zig3 <- zeroinfl(Average.No.of.Aphids~Ants.Presence+
                   Mat.Location+Season+Average.Temp+
                   Relative.Humidity+Average.Rainfall|Ants.Presence+
                   Mat.Location+Season+Average.Temp+
                   Relative.Humidity+Average.Rainfall,
                 data = OBJ3,dist = "geometric")
...
######## OBJECTIF 4 #####################
OBJ4 <- read.csv(file = file.choose(),header = T,
                 sep = ";",dec = ",",stringsAsFactors = F)
...
zip4 <- zeroinfl(Average.No.of.Aphids~Ants.Presence+
                   Mat.Location+Season+Plant.Stage+
                   Aphid.Density.Category|Ants.Presence+
                   Mat.Location+Season+Plant.Stage+
                   Aphid.Density.Category,
...
### Zero inflated negative binomial
zig4 <- zeroinfl(Average.No.of.Aphids~Ants.Presence+
                   Mat.Location+Season+Plant.Stage+
                   Aphid.Density.Category|Ants.Presence+
                   Mat.Location+Season+Plant.Stage+
                   Aphid.Density.Category,
                 data = OBJ4,dist = "geometric")
